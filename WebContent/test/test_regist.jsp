        ...
        <div class="col-md-2">
          ...
          <select name="no" class="form-select">
            ...
            <c:forEach begin="1" end="2" var="i">
              <c:set var="iStr" value="${i}" />
              <option value="${iStr}" <c:if test="${iStr == no}">selected</c:if>>${iStr}</option>
            </c:forEach>
          </select>
        </div>
            ...
            <tbody>
              <c:forEach var="t" items="${list}">
                <tr>
                  ...
                  <td>${t.studentName}</td>
                  <td>
                    <input type="number" class="form-control text-center" name="point_${t.studentNo}" value="${t.point}" min="0" max="100" required />
                  </td>
                  <td>
                    <div class="form-check text-center">
                      <input type="checkbox" class="form-check-input" name="delete" value="${t.studentNo}" />
                    </div>
                  </td>
                </tr>
              </c:forEach>
