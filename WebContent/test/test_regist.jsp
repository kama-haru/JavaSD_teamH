...
<c:import url="/base.jsp">
  ...
  <c:param name="body">
    <div class="container my-5">
      ...
      <form method="get" action="test_regist" class="mb-4">
        ...
        <div class="row g-2 align-items-end">
          <div class="col-md-2">
            ...
            <select name="entYear" class="form-select form-select-sm">
              <option value="">------</option>
          ...
          <div class="col-md-3">
            ...
            <select name="subjectCd" class="form-select form-select-sm">
              <option value="">------</option>
          ...
          <div class="col-md-2">
            ...
            <select name="no" class="form-select form-select-sm">
              <option value="">------</option>
      ...
      <!-- 成績が存在しない -->
      <c:if test="${empty list && not empty entYear && not empty classNum && not empty subjectCd && not empty no && empty error}">
              ...
              <c:forEach var="t" items="${list}">
                <tr>
                  ...
                  <td>
                    ...
                    <c:if test="${not empty errorMap[t.studentNo]}">
                      <div class="text-danger small mt-1">${errorMap[t.studentNo]}</div>
                    </c:if>
                  </td>
                  <td>
                    <input type="checkbox" class="form-check-input"
                           name="delete" value="${t.studentNo}" />
                  </td>
                </tr>
              </c:forEach>
            </tbody>
